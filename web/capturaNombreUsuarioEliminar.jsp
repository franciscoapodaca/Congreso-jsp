<%-- 
    Document   : capturaNombreUsuarioEliminar
    Created on : 13/05/2015, 03:09:49 AM
    Author     : Kathya
--%>
...
<!-- Captura clave y tipo de presentación -->
        <form name="frmCapturaNomUsuario" action="AdmUsuarios" method="get" >
                    ...
                    <div>
                        <table>                           
                            <tbody>
                                <tr>
                                    <td WIDTH="50" 
                                        HEIGHT="50">Nombre de usuario</td>
                                    <td><input type="text" name="txtNomU" value="" /></td>                                    
                                </tr>
                            </tbody>
                        </table>
                        <table>
                            <thead>
                                <tr>
                                    <th><input type="submit" value="Eliminar" name="btn" /></th>
                                    <th></th>
