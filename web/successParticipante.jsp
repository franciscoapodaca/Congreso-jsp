...
<html>
    <head>
       <meta charset=utf-8>
        ...
        <title>Gesti&oacute;n Participantes - Correcto Participante</title>
        <!-- Load Roboto font -->
            ...
            <div class="container">
                ...
                <div class="tablar">
                    <table>
                        <thead>
                            <tr>
                                <th><a href="http://localhost:8080/Congreso/gestionParticipantes.jsp"><input type="button" value="Continuar" name="boton" /></a></th>
                            </tr>
                        </thead>
                        <tbody>
                        </tbody>
