<%-- 
    Document   : capturaClaveTParticipante
    Created on : 13/05/2015, 11:38:37 AM
    Author     : Kathya
--%>
...
<html>
    ...
    <body>
        ...
        <form name="frmCapturaClavePresentacion"  onSubmit="return validaClavePresentacion()" action="agregarParticipante.jsp" method="get" >
                    ...
                    <div>
                        <table>                           
                            <tbody>
                                ...
                                <tr>
                                    <td WIDTH="50" 
                                        HEIGHT="50">Tipo de Participante</td>
                                ...
                                <tr>
                                    <td></td>
                                    <td></td>
                                    <td><input type="submit" value="Enviar" name="btn" /></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
