...
<html>
    ...
    <body>
        ...
        <form name="frmConsultar" action="AdmPresentacion" method="get">
            <div class="section primary-section" id="service">
                <div class="container">
                    <!-- Start title section -->
                    <div class="title">
                        <h1>Consulta de Presentaciones Por Per&iacute;odo</h1>
                        <!-- Section's title goes here -->
                        <!--Simple description for section goes here. -->
                    </div>
                    <div>
                        <center>
                            Fecha:<input type="date" name="txtFecha" value="" />
                                <input type="submit" name="consultaFecha" value="Consultar Fecha" />
                            <table  >                      
                                <tbody>
                                    ...
                                    <%
                                        ...
                                        if(fecha==null || fecha.equals("")){
                                            ...
                                            Date date= new SimpleDateFormat("dd:mm:aa").parse(fecha);
                                        }
                                        ...
                                        String sql = " SELECT * FROM PRESENTACION where fecha='"+fecha+"'";
