<%-- 
    Document   : capturaClaveTPresentacion
    Created on : 4/05/2015, 12:55:12 AM
    Author     : Kathya
--%>
...
<html>
    <head>
        ...
        <title>Gesti&oacute;n Participantes - Agregar Participante</title>
        <!-- Load Roboto font -->
...
<!-- Captura clave y tipo de presentación -->
        <form name="frmCapturaClavePresentacion"  onSubmit="return validaClavePresentacion()" action="agregarPresentacion.jsp" method="get" >
                        ...
                        <table>                           
                            <tbody>
                                <tr>
                                    <td WIDTH="50" 
                                        HEIGHT="50">Clave</td>
                                    <td><input name="claveP" id="claveP" size="7" onchange="validaClavePresentacion(this, 'txtClave');" /></td>
                                    <td id="txtClave">&nbsp;</td>
                                </tr>
                                <tr>
                                    <td WIDTH="50" 
                                        HEIGHT="50">Tipo de Presentaci&oacute;n</td>
                                    <td><select name="txtPTip">
                                            <option>Conferencia</option>
                                            <option>Ponencia</option>
                                        </select></td>
                                </tr>
                                <tr>
                                    <th><input type="submit" value="Enviar" name="btn" /></th>
                                    <th><a href="http://localhost:8080/Congreso/gestionPresentaciones.jsp"><input type="button" value="Cancelar" name="btn"  /></a></th>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
<!-- Fin de Captura clave y tipo de presentación -->
