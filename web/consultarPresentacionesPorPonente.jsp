...
<html>
    <head>
        ...
        <title>Gesti&oacute;n Participantes - Consultar Presentaci&oacute;nes Por Ponente</title>
        <!-- Load Roboto font -->
        ...
        <form name="frmConsultar" action="AdmPresentacion" >
            <div class="section primary-section" id="service">
                <div class="container">
                    <!-- Start title section -->
                    <div class="title">
                        <h1>Consulta de Presentaciones Por Ponente</h1>
                    ...
                    <div>
                        <center>
                            ...
                            Ponente: <input type="text" name="txtPonente" value="" />
                            <input type="submit" name="consultaPonente" value="Consultar ponente" />
                            ...
                            <table  >                      
                                <tbody>
                                    ...
                                    <%
                                        ...
                                        String ponente = request.getParameter("txtPonente");
                                        ...
                                        String sql = " SELECT * FROM PRESENTACION where clave='"+ponente+"'";
