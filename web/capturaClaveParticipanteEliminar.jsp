<%-- 
    Document   : capturaClaveParticipanteEliminar
    Created on : 13/05/2015, 02:11:07 PM
    Author     : Kathya
--%>
...
<!-- Captura clave y tipo de presentación -->
        <form name="frmCapturaElimina" action="AdmParticipantes" method="get" >
            <div class="section primary-section" id="service">
                <div class="container">
                    <!-- Start title section -->
                    <div class="title">
                        <h1>Gesti&oacute;n de Participante</h1>
                    ...
                    <div>
                        <table>                           
                            <tbody>
                                <tr>
                                    <td WIDTH="50" 
                                        HEIGHT="50">Clave Participante</td>
                                    <td><input type="text" name="txtNomU" value="" /></td>                                    
                                </tr>
                                <tr>
                                    <td></td>
                                    <td></td>
                                    <td><input type="submit" value="Eliminar" name="btn" /></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
