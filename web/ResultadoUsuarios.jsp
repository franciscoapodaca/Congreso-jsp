<%-- 
    ...
    Created on : 13/05/2015, 01:31:43 AM
    Author     : Kathya
--%>
...
<html>
    <head>
        ...
        <title>Gesti&oacute;n Usuarios - Congreso Web</title>
        <!-- Load Roboto font -->
            ...
            <div class="section primary-section" id="service">
                <div class="container">
                    ...
                    <div class="title">
                        ...
                        <p>La siguiente tabla muestra los registros de los usuarios.</p>
                    ...
                    <div class="tablaP">
                                ...
                                <%
                                    ...
                                    String sql = "select nombreU,tipoUsuario from Usuario";
                                    ResultSet tabla = state.executeQuery(sql);
                                    out.println("<center>");
                                    out.println("<table border=1 cellPadding=1><tr>");
                                    out.println("<th>Nombre</th><th>Tipo de Usuario</th>");
                                    while (tabla.next()) {
                                        out.println("<tr>");
