...
<html>
    <head>
       <meta charset=utf-8>
        ...
        <title>Gesti&oacute;n Participantes - Consulta Participante</title>
        <!-- Load Roboto font -->
            ...
            <div class="container">
                ...
                <form action="participantes">
                        ...
                        <tbody>
                            <tr>
                                <td>Clave:</td>
                                <td><input type="text" name="txtClave" value="" placeholder="CDE00?..."  maxlength="10" required/></td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table>
                        <thead>
                            <tr>
                                <th><input type="submit" value="Consultar" name="boton" /></th>
                               <th></th>
                                <th><input type="reset" value="Restablecer" name="boton" /></th>
                                <th></th>
