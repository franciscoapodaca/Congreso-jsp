...
<html>
    <head>
        ...
        <title>Gesti&oacute;n Participantes - Consultar Presentaci&oacute;nes</title>
        <!-- Load Roboto font -->
    ...
    <body>
        ...
        <form name="frmConsultar" action="gestionPresentaciones.jsp" method="get">
            <div class="section primary-section" id="service">
                <div class="container">
                    <!-- Start title section -->
                    <div class="title">
                        <h1>Consulta de Presentaciones</h1>
                        ...
                        <center>
                            ...
                            <table>
                                <thead>
                                    <tr>
                                <br>       
                                <th><input type="submit" value="Regresar" name="btn" /></th>
                                </br>
                                </tr>
                                </thead>
                                <tbody>
