...
<html>
    ...
    <body>
        ...
        <form action="AdmParticipantes" method="get">
            ...
            <div class="container">
                ...
                <div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Nombre:</td>
                                <td><input type="text" name="txtNombre" value="" request/></td>
                            </tr>
                            <tr>
                                <td>Correo Electr&oacute;nico:</td>
                                <td><input type="email" name="txtEmail" value="" placeholder="Ingresa Email" request/></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>Carrera:</td>
                                <td><input type="text" name="txtCarrera" value="" /></td>
                            </tr>
                            <%}%>
                            ...
                            <tr>
                                <td>Puesto:</td>
                                <td><input type="text" name="txtPuesto" value="" /></td>
                            </tr>
                            <%}%>
                        </tbody>
                    </table>
                        ...
                        <thead>
                            <tr>
                               ...
                               <th></th>
                                ...
                                <th></th>
                                <th><a href="http://localhost:8080/Congreso/gestionParticipantes.jsp"><input type="button" value="Cancelar"/></a></th>
                            </tr>
                        </thead>
                        <tbody>
                        </tbody>
