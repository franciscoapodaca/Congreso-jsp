<%-- 
    Document   : capturaClaveParticipante
    Created on : 13/05/2015, 01:07:25 PM
    Author     : Kathya
--%>
...
<!-- Captura clave y tipo de presentación -->
        <form name="frmCapturaClaParti" action="AdmParticipantes" method="get" >
            <div class="section primary-section" id="service">
                <div class="container">
                    <!-- Start title section -->
                    <div class="title">
                        <h1>Gesti&oacute;n de Participantes</h1>
                    ...
                    <div>
                        <table>                           
                            <tbody>
                                <tr>
                                    <td WIDTH="50" 
                                        HEIGHT="50">Clave de Participante</td>
