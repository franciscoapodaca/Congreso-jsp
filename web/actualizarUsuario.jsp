<%-- 
    ...
    Created on : 13/05/2015, 01:42:12 AM
    Author     : Kathya
--%>
...
<html>
    <head>
        ...
        <title>Gesti&oacute;n Usuario - > Actualiza Usuario</title>
        <!-- Load Roboto font -->
    ...
    <body>
        ...
        <form name="frmActualizar" action="AdmUsuarios" method="get">
            <div class="section primary-section" id="service">
                <div class="container">
                    <!-- Start title section -->
                    <div class="title">
                        <h1>Actualizar registros de Usuarios</h1>
                        ...
                        <table >                      
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="text" name="txtnomU" value="<%=clave%>" readonly/></td>
                                </tr>
                                <tr>
                                    <% //Este es el driver
                                    String contra=null;
                                        ...
                                        String sql = "select password from usuario " + " where nombreU= '" + clave + "'";
                                      ResultSet tabla = state.executeQuery(sql);
                                    while(tabla.next()){
                                         contra = tabla.getString("password");
                                    }
                                    %>
                                    <td>Contraseña:</td>
                                    <td><input type=password name="txtContra" value="<%=contra%>" /></td>
                                </tr>
                                <tr>
                                     <% //Este es el driver
                                    String tipo=null;
                                        
                                        String sql2 = "select tipoUsuario from usuario " + " where nombreU= '" + clave + "'";
                                      ResultSet tabla2 = state.executeQuery(sql2);
                                    while(tabla2.next()){
                                         tipo = tabla2.getString("tipoUsuario");
                                    }
                                    %>
                                    <td>Tipo de Usuario:</td>
                                    <td><select name="txttu">
                        ...
                        <table>
                            <thead>
                                <tr>
                                    ...
                                    <th></th>
                                    <th><a href="http://localhost:8080/Congreso/gestionUsuarios.jsp"><input type="button" value="Cancelar" name="btn"  /></a></th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
