<%-- 
    Document   : ResultadoParticipantes
    Created on : 13/05/2015, 02:16:24 PM
    Author     : Kathya
--%>
...
<html>
    <head>
        ...
        <title>Gesti&oacute;n Participantes - Congreso Web</title>
        <!-- Load Roboto font -->
            ...
            <div class="section primary-section" id="service">
                <div class="container">
                    ...
                    <div class="title">
                        ...
                        <p>La siguiente tabla muestra los registros de los participantes.</p>
                    ...
                    <div class="tablaP">
                                ...
                                <%
                                    ...
                                    out.println("<th>Clave</th><th>Nombre</th><th>Email</th><th>Tipo de Participante</th><th>Carrera</th><th>Puesto</th>");
                                    while (tabla.next()) {
                                        out.println("<tr>");
